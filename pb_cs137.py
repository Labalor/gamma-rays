...
pb_cs137 = [d_cs_pb2, d_cs_pb4, d_cs_pb6, d_cs_pb8]
pb_cs137_name = ['pb2_', 'pb4_', 'pb6_', 'pb8_']
a_pb = []; b_pb = []; c_pb = []

print('\n\n         Cs137 con Pb: ')
print('         Valores del ajuste gaussiano \n')

for i in range(len(pb_cs137)):


	fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(14, 10))
	ax.set_title('Espectro de Cs137 - Pb 2 mm', fontsize=20)
	ax.set_ylabel(r'$\Phi$ (Cuentas)', fontsize=20); ax.set_xlabel('Energía (keV)', fontsize=20)

	# datos 


	y_data = pb_cs137[i] - d_bkg # d_cs0
	...
	a_pb.append([pb_cs137_name[i] + 'a', a1[0], st[0]])		
	b_pb.append([pb_cs137_name[i] + 'b', a1[1], st[1]])	
	c_pb.append([pb_cs137_name[i] + 'c', a1[2], st[2]])
	...
	plt.savefig('./images/' + pb_cs137_name[i] + 'cs137_gaussian.png') 
